...
def graph_water_transformer_cov(input_shape, gcn1, gcn2, lstm_unit, num_transformer_blocks, head_size, num_heads, ff_dim, atte_reg, l1_reg, l2_reg, dropout, masked_value):
    """
    transformer_cov
    graph_water
    """
    ...
    # ======================== final output ========================
    x = Flatten()(x)
    out = Dense(96, name='final_dense')(x)
...
def graph_water_transformer_cov_gate_predictor(input_shape, gcn1, gcn2, lstm_unit, num_transformer_blocks, head_size, num_heads, ff_dim, atte_reg, l1_reg, l2_reg, dropout, masked_value):
    """
    transformer_cov
    graph_water
    """
...
def graph_water_transformer_cov_gate_predictor_1(input_shape, gcn1, gcn2, lstm_unit, num_transformer_blocks, head_size, num_heads, ff_dim, atte_reg, l1_reg, l2_reg, dropout, masked_value, gate_min, gate_max):
    """
    transformer_cov
    graph_water
    """
...
def graph_water_transformer_cov_gate_predictor_2(input_shape, gcn1, gcn2, lstm_unit, num_transformer_blocks, head_size, num_heads, ff_dim, atte_reg, l1_reg, l2_reg, dropout, masked_value, gate_min, gate_max):
    """
    transformer_cov
    graph_water
    """
