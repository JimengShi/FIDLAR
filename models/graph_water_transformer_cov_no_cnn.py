...
def transformer_encoder_1(inputs, head_size, num_heads, ff_dim, atte_reg, l1_reg, l2_reg, dropout=0):
    """
    transformer encoder
    """
...
def graph_water_transformer_cov_gate_predictor_no_cnn(input_shape, gcn1, gcn2, lstm_unit, num_transformer_blocks, head_size, num_heads, ff_dim, atte_reg, l1_reg, l2_reg, dropout, masked_value, gate_min, gate_max):
    """
    transformer_cov
    graph_water
    """
    ...
    for _ in range(num_transformer_blocks):
        cov = transformer_encoder_1(cov, head_size, num_heads, ff_dim, atte_reg, l1_reg, l2_reg, dropout)
