...
def graph_water_transformer_cov_gate_predictor_no_lstm(input_shape, gcn1, gcn2, num_transformer_blocks, head_size, num_heads, ff_dim, atte_reg, l1_reg, l2_reg, dropout, masked_value, gate_min, gate_max):
    """
    transformer_cov
    graph_water
    """
    ...
    x = Concatenate(name='concate')([cov_reshape, x])
